...
public partial class GameEntity {
    ...
    public Assets.Scripts.Features.Health.HealthComponent health { get { return (Assets.Scripts.Features.Health.HealthComponent)GetComponent(GameComponentsLookup.Health); } }
    public bool hasHealth { get { return HasComponent(GameComponentsLookup.Health); } }

    public void AddHealth(int newValue, UnityEngine.Vector3 newHitPos) {
        var index = GameComponentsLookup.Health;
        var component = (Assets.Scripts.Features.Health.HealthComponent)CreateComponent(index, typeof(Assets.Scripts.Features.Health.HealthComponent));
        component.value = newValue;
        component.hitPos = newHitPos;
        AddComponent(index, component);
    }

    public void ReplaceHealth(int newValue, UnityEngine.Vector3 newHitPos) {
        var index = GameComponentsLookup.Health;
        var component = (Assets.Scripts.Features.Health.HealthComponent)CreateComponent(index, typeof(Assets.Scripts.Features.Health.HealthComponent));
        component.value = newValue;
        component.hitPos = newHitPos;
