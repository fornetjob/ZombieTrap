...
public partial class GameEntity {
    ...
    public Assets.Scripts.Features.Core.Position.PositionComponent position { get { return (Assets.Scripts.Features.Core.Position.PositionComponent)GetComponent(GameComponentsLookup.Position); } }
    ...
    public void AddPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Assets.Scripts.Features.Core.Position.PositionComponent)CreateComponent(index, typeof(Assets.Scripts.Features.Core.Position.PositionComponent));
