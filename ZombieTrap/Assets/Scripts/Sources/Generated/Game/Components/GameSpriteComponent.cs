...
public partial class GameEntity {
    ...
    public Assets.Scripts.Features.Core.Sprites.SpriteComponent sprite { get { return (Assets.Scripts.Features.Core.Sprites.SpriteComponent)GetComponent(GameComponentsLookup.Sprite); } }
    ...
    public void AddSprite(UnityEngine.Sprite newValue) {
        ...
        var component = (Assets.Scripts.Features.Core.Sprites.SpriteComponent)CreateComponent(index, typeof(Assets.Scripts.Features.Core.Sprites.SpriteComponent));
